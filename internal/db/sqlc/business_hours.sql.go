...
func (q *Queries) CreateBusinessHours(ctx context.Context, arg CreateBusinessHoursParams) (BusinessHour, error) {
	row := q.queryRow(ctx, q.createBusinessHoursStmt, createBusinessHours,
		arg.BusinessID,
		arg.DayOfWeek,
		arg.OpenTime,
		arg.CloseTime,
...
func (q *Queries) DeleteBusinessHour(ctx context.Context, id int64) (BusinessHour, error) {
	row := q.queryRow(ctx, q.deleteBusinessHourStmt, deleteBusinessHour, id)
	var i BusinessHour
	err := row.Scan(
		&i.ID,
		&i.BusinessID,
...
func (q *Queries) GetBusinessHour(ctx context.Context, id int64) (BusinessHour, error) {
	row := q.queryRow(ctx, q.getBusinessHourStmt, getBusinessHour, id)
	var i BusinessHour
	err := row.Scan(
		&i.ID,
		&i.BusinessID,
...
func (q *Queries) ListBusinessHours(ctx context.Context, arg ListBusinessHoursParams) ([]BusinessHour, error) {
	rows, err := q.query(ctx, q.listBusinessHoursStmt, listBusinessHours, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) UpdateBusinessHour(ctx context.Context, arg UpdateBusinessHourParams) error {
	_, err := q.exec(ctx, q.updateBusinessHourStmt, updateBusinessHour,
		arg.ID,
		arg.BusinessID,
		arg.DayOfWeek,
		arg.OpenTime,
